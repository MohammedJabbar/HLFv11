...
presetup() {
    ...
    pushd ./../../artifacts/src/github.com/node/go
...
VERSION="1"
CC_SRC_PATH="./../../artifacts/src/github.com/node/go"
CC_NAME="node"
...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        --peerAddresses localhost:11051 --tlsRootCertFiles $PEER0_ORG3_CA \
        -c '{"function": "createNode","Args":["Node-ABCDEEE", "Audi", "R8", "Red", "Sandip"]}'
...
chaincodeQuery() {
    ...
    # Query Node by Id
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "queryNode","Args":["Node0"]}'
